...
class BaoZhangRenPage extends Component {
  static PropTypes = {
...
function mapStateToProps(state) {
  return {
    node: state.baozhangren.node,
    checkedItems: state.baozhangren.checkedItems
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(BaoZhangRenPage);
